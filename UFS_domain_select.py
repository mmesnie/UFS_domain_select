...
config_yaml = f"{UFS_DOMAIN_SELECT_HOME}/build/ufs-srweather-app-2.2.0/ush/config.yaml"
predef_grid_params_yaml = f"{UFS_DOMAIN_SELECT_HOME}/build/ufs-srweather-app-2.2.0/ush/predef_grid_params.yaml"
