...
[[ -d genf90 ]] || git clone https://github.com/PARALLELIO/genf90.git -b genf90_200608
...
# Mesnier: added -DPIO_ENABLE_EXAMPLES=OFF so that it builds OK
...
cmake ..\
  ...
  $CMAKE_FLAGS -DPIO_ENABLE_TIMING=ON

#CC=mpicc FC=mpif90 cmake .. -DNetCDF_PATH=${NETCDF_ROOT:-} -DHDF5_PATH=${HDF5_ROOT:-} -DGENF90_PATH=/home/mmesnie/hpc-stack/pkg/pio-2.5.10/genf90/ -DWITH_PNETCDF=OFF $CMAKE_FLAGS
