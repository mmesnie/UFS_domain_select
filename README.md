...
# Tested Spack stack platforms (the do-all script)

| Distribution | Stack | UFS model | Last tested OK  |
| ---          | ---   | ---       | ---             |
| Ubuntu 24.04 | spack | 3.0.0     | 5/4/26          |
| Ubuntu 24.04 | spack | 2.2.0     | 5/4/26          |
| Ubuntu 22.04 | spack | 3.0.0     | 5/4/26          |
| Ubuntu 22.04 | spack | 2.2.0     | 5/4/26          |
| Ubuntu 20.04 | spack | 3.0.0     | 5/4/26          |
| Ubuntu 20.04 | spack | 2.2.0     | 5/4/26          |
| Ubuntu 18.04 | spack | 3.0.0     | 5/4/26          |
| Ubuntu 18.04 | spack | 2.2.0     | 5/4/26          |
...
# Tested HPC stack platforms (the do-all script)
...
2. Hover your mouse over the Lambert Conformal or Rotated Pole grid and press 'y'
   ...
   the config.yaml.tmpl file in the scripts directory. The do-forecast script
...
file (located in the scripts directory). Rename this file to config.yaml, update each 
